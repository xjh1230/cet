...
def get_form(args_name, msg, is_strip=True, lenght=0, is_check_null=False, notify_msg='', is_check_special_char=False):
    """
    获取客户端Form方式提交的参数值
    :param args_name: 参数名
    :param msg: 参数中文名称
...
def get_query(args_name, msg, is_strip=True, lenght=0, is_check_null=False, notify_msg='', is_check_special_char=True):
    """
    获取客户端Get方式提交的参数值
    :param args_name: 参数名
    :param msg: 参数中文名称
...
def __request_handle(args_value, msg, is_strip, lenght, is_check_null, notify_msg, is_check_special_char):
    ...
    try:
        # print(args_value)
        args_value = urllib.parse.unquote(args_value) #解码
        # urllib.parse.quote(args_value)  编码
    except:
        pass
